...
namespace PROJECT
{
    public partial class KostRecomendationns : Form
    {
        public KostRecomendationns()
        {
            InitializeComponent();
        }
        ...
        {
            kospria1 kospria11 = new kospria1();
            kospria11.Show();
            this.Hide();
        }
        ...
        {
            kospria2 kospria22 = new kospria2();
            kospria22.Show();
            this.Hide();
        }
        ...
        {
            koswanita1 koswanita11 = new koswanita1();
            koswanita11.Show();
            this.Hide();
        }
        ...
        {
            koswanita2 koswanita22 = new koswanita2();
            koswanita22.Show();
            this.Hide();
        }
    }
